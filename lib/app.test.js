...
// it('Should add a server with proper `networkOpts`', () => {
// 	const dispatchServer = require('./dispatch-server')
// 	const dispatchServerSpy = jest.spyOn(dispatchServer.prototype, 'addServer')

// 	const app = new App('testing', false, { port: 2345 })

// 	expect(dispatchServerSpy).toHaveBeenCalled()
// })
