...
module.exports = {
	parseType(type, required) {
		...
		if (typeof type === 'function') {
			return Object.assign({}, expandTypeConstructor(type), { optional: !required })
		}
		...
		if (typeof type === 'object' && !type.type) {
			return {
				type: 'object',
				optional: !required,
				properties: Object.keys(type).reduce((acc, key) => Object.assign({}, acc, {
					[key]: this.parseType(type[key], type[key].required)
				}), {})	
			}
		} else if (type.type) {
			let finalType
			...
			if (typeof type.type === 'function') {
				finalType = Object.assign({}, type, expandTypeConstructor(type.type), { optional: !required })
			} else {
				finalType = type
			}

			if (type.validator) {
				finalType = Object.assign({}, finalType, {
